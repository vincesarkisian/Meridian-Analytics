...
- **Two or three things you rejected or reworked, and why**:
  ...
  2. I considered email-domain routing for SSO, but reworked it to a simple entry point. It is more reliable for the demo, and proving we work with Okta is table stakes that the dashboard already shows.
