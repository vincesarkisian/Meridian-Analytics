...
| --------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Admin** — Vince Sarkisian (Acme Corp)             | vince.sarkisian@gmail.com    | `AEG8jmz*tna3mtf3fez`                                                                                              | `/members`: full management — invite, remove, change a member's role. `/account`: all three capabilities green. Home page: "Enterprise SSO" routes to Acme's Test IdP. |
| **Team lead** — Tyrion Lannister (Acme Corp)        | vince.sarkisian1+1@gmail.com | `ryw_zvw_GBE_xen9thq`                                                                                              | `/members`: invite, remove, and change a member's role (the widget). `/account`: all three capabilities green. Unlike admin, cannot open `/integrations` (admin-only).        |
